...
sed -i "s/CURSUS =.*/CURSUS = \"$CURSUS\"/" check_mark_campus_booster.py
...
unset PIP_VERSION IDBOOSTER SUPINFO_PASSWORD GMAIL_ADDRESS GMAIL_PASSWORD RECEIVER_ADDRESS BROWSER CURSUS

# Change permissions of the main file to block access to passwords and others
chmod 700 check_mark_campus_booster.py
